...
path = 'C:\\Users\\gboschin\\Desktop\\API linkedin\\Outputs'
...
df_profiles.to_excel(path,'profiles.xlsx', sheet_name='Profiles', index=False)

print('Perfiles exportados en excel')
...
df_profiles.to_excel(path,'info_perfiles.xlsx')

print('Dataframe info perfiles exportado ')
